  ...
  return (
    <>
      ...
      <Paper p='md'>
        ...
        >
          <Checkbox color='blue.4' value='portalInfos' label={GetForcedStringLocale("ui_infos")} />
          <Checkbox color='blue.4' value='portalPoly' label={GetForcedStringLocale("ui_fill_portals")} />
          <Checkbox color='blue.4' value='portalLines' label={GetForcedStringLocale("ui_outline_portals")} />
          <Checkbox color='blue.4' value='portalCorners' label={GetForcedStringLocale("ui_corcers_portals")} />
        </Checkbox.Group>
