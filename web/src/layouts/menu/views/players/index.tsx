        ...
        <Accordion.Panel>
          ...
          <Group grow spacing='xs'>
            <Button variant='light' color={'blue.4'} size='xs' onClick={() => { fetchNui('flight_admin:placeMarkerAtPlayer', player.id); }}>
              {GetLocale("ui.player.button.place_marker")}
            </Button>

            <Button variant='light' color={pressTpMarker ? 'teal' : 'blue.4'} size='xs' onClick={() => { setPressTpMarker(true); fetchNui('flight_admin:tpMarkerPlayer', player.id); }}>
          ...
          <Group grow spacing='xs'> 
            ...
            { player.bringPlayer ? 
              <Button variant='light' color={'red.4'} size='xs' onClick={() => { fetchNui('flight_admin:bringBackPlayer', player.id); }}>
            ...
            { player.gotoPlayer ? 
              <Button variant='light' color={'red.4'} size='xs' onClick={() => { fetchNui('flight_admin:goBackPlayer', player.id); }}>
